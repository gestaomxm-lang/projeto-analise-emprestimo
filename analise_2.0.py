...
def analisar_itens(df_saida, df_entrada, limiar_similaridade=65, progress_bar=None):
    ...
    # Formatação de Data para String (YYYY-MM-DD HH:MM:SS) - visualização e excel
    def _format_dt(x):
    ...
    if 'Data' in df_resultado.columns:
        df_resultado['Data_Obj'] = df_resultado['Data'] # Mantém original para cálculos se precisar
        df_resultado['Data'] = df_resultado['Data'].apply(_format_dt)
        
    if 'Data Entrada' in df_resultado.columns:
        df_resultado['Data Entrada'] = df_resultado['Data Entrada'].apply(_format_dt)
